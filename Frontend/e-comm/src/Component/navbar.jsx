...
//  -------------------------------------------------------------------------------------------------
    ...
    return (
        <>
            <nav className="d-flex container-fluid bg-warning justify-content-between px-5 py-3 border border-dark fluid">
                <div className="fs-4">A-MART</div>
                ...
                {!data ? (
                    <div className="d-flex justify-content-between">
                        <Link to={'/login'}><button className="btn btn-dark px-2 mx-2">Login</button></Link>
                        <Link to={'/register'}><div className="btn btn-dark px-2 mx-2">Register</div></Link>
                    </div>)
                    : (
